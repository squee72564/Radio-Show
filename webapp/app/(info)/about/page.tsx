  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-12">
      ...
      <p className="text-muted-foreground text-lg">
        MugenBeat is a free, open internet radio platform built for DJs, listeners, and music
        lovers.
      </p>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card>
          ...
          <CardContent>
            <p className="text-muted-foreground">
              Sign up, authenticate, and stream live directly through <strong>Icecast</strong> and{' '}
              <strong>Liquidsoap</strong>. Each show is archived automatically for later playback.
            </p>
            <Badge variant="outline" className="mt-4">
              Live Streaming
            </Badge>
            <Badge variant="outline" className="ml-2 mt-4">
              Automatic Archiving
            </Badge>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-muted-foreground">
              Tune into ongoing live DJ sets or explore past broadcasts via the archive. Enjoy a
              non-corporate, community-powered radio experience.
            </p>
            <Badge variant="outline" className="mt-4">
              Live Shows
            </Badge>
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-muted-foreground mb-4">
            This platform is built using modern, open-source tools to ensure flexibility,
            reliability, and developer-friendliness.
          </p>
      ...
      <Card>
        ...
        <CardContent className="pt-6">
          ...
          <a
            href="https://github.com/squee72564/Radio-Show"
            target="_blank"
