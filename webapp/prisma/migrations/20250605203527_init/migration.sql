...
-- CreateIndex
CREATE UNIQUE INDEX "StreamSchedule_metadataId_key" ON "StreamSchedule"("metadataId");
...
-- AddForeignKey
ALTER TABLE "StreamSchedule" ADD CONSTRAINT "StreamSchedule_metadataId_fkey" FOREIGN KEY ("metadataId") REFERENCES "StreamMetadata"("id") ON DELETE CASCADE ON UPDATE CASCADE;
